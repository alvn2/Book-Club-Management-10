...
with app.app_context():
    ...
    bookclub6 = Bookclub(
        name="Bookclub 6", description="A bookclub for teens.", owner_id=1)
    bookclub7 = Bookclub(
        name="Bookclub 7", description="A bookclub for the elderly.", owner_id=2)
    bookclub8 = Bookclub(
        name="Bookclub 8", description="A bookclub for the young at heart.", owner_id=3)
    bookclub9 = Bookclub(
        name="Bookclub 9", description="A bookclub for the history buff.", owner_id=4)
    bookclub10 = Bookclub(
        name="Bookclub 10", description="A bookclub for the science fiction lover.", owner_id=5)
    
    bookclubs = [bookclub1, bookclub2, bookclub3, bookclub4, bookclub5, bookclub6, bookclub7, bookclub8, bookclub9, bookclub10]
